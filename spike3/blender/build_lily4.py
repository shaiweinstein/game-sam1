...
def main():
    ...
    for sx, col in ((1, 9), (-1, 33)):
        ...
        # The conformed rig bends at z=.495 with its wrist at .399, not the
        # historical .409/.318 mesh hints. Support those joints, then broaden
        # the flattened palm and thumb without adding intersecting parts.
        arm_rows = [  # z, x, y, width, depth, thumb
            (.529, .131, .012, .033, .032, 0),
            (.518, .136, .018, .032, .031, 0),
            (.507, .140, .024, .030, .030, 0),
            (.498, .144, .027, .028, .027, 0),
            (.490, .147, .027, .027, .026, 0),
            (.481, .149, .023, .028, .028, 0),
            (.469, .151, .017, .029, .029, 0),
            (.452, .154, .009, .0275, .028, 0),
            (.435, .156, .002, .025, .026, 0),
            (.419, .159, -.003, .022, .023, 0),
            (.408, .161, -.007, .020, .021, 0),
            (.399, .162, -.009, .019, .020, 0),
            (.391, .163, -.010, .020, .019, .001),
            (.382, .164, -.011, .024, .021, .006),
            (.373, .165, -.013, .029, .023, .014),
            (.363, .167, -.015, .032, .024, .015),
            (.352, .168, -.017, .033, .024, .009),
            (.340, .169, -.019, .031, .022, .002),
            (.329, .170, -.020, .027, .019, 0),
            (.320, .170, -.020, .020, .014, 0),
            (.315, .170, -.020, .012, .009, 0),
            (.312, .170, -.020, .005, .004, 0),
        ]
        rows = []
